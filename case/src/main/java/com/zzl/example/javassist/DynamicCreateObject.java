...
public class DynamicCreateObject {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, Object> fieldMap = new HashMap<>();// 属性-取值map
        ...
        team = dco.addField("com.dmall.jingwei.marketing.aspect.Team", fieldMap);// //创建一个名称为Team的类
    ...
    public Object addField(String className, Map<String, Object> fieldMap) throws Exception{
        ...
        CtClass ctClass = pool.makeClass(className, pool.get(DynamicCreateObject.class.getName()));// 创建javassist类
        // 为创建的类ctClass添加属性
        ...
        FileOutputStream fos = new FileOutputStream(new File("D://MyCC2.class"));
        fos.write(byteArr);
        fos.close();
